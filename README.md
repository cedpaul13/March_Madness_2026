...
A high-performance predictive pipeline for the **2026 NCAA Division I Men's and Women's Basketball Tournaments**. This project utilizes the **CFA Fusion** model, integrating advanced efficiency metrics (AdjOE/AdjDE), momentum filters, and expert sentiment analysis to generate optimized tournament brackets.
...
| Team | Score | Vegas ML | Spread |
| :--- | :--- | :--- | :--- |
| **Connecticut** | **70** | **-105** | **-0.5** |
| South Carolina | 68 | 105 | +0.5 |
